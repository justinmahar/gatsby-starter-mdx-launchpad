...
import Settings, {
  ...
  FormInfo,
  useSettings,
} from '../../../plugins/boldlypress-core/src/data/useSettings';
import useContactForm, {
  ContactFormField,
  FormModel,
} from '../../../plugins/boldlypress-core/src/hooks/useContactForm';
...
export default function MailingListSignupContainer(props: MailingListSignupContainerProps): JSX.Element {
  ...
  const templateTags: TemplateTags | undefined = undefined;
      ...
      <div key={`field-${formField.nameAttribute}`}>
        <Form.Group controlId={formField.nameAttribute}>
          ...
          <Form.Control
            ...
            onChange={(e: any) => formModel.setFieldValue(formField.nameAttribute, e.currentTarget.value)}
          />
