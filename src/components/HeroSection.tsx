    ...
    <div style={{ background: 'white' }}>
      <Container>
        <Row>
          ...
          <Col>
            Paragraph text Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel eius molestiae illo dolor
            magnam, voluptates esse accusamus reprehenderit dolorem voluptatibus.
          </Col>
          <Col>
