...
export default function PageLayout(props: IPageLayoutProps) {
  ...
  if (mdxContent.data.frontmatter.seoSettings.seoImage.seoImageSelection === "featured-image-if-enabled") {
    if (mdxContent.data.frontmatter.featuredImage.featuredImageEnabled) {
      ...
      seoImageAlt = mdxContent.data.frontmatter.featuredImage.featuredImageAlt !== "none" ? renderTemplateTags(mdxContent.data.frontmatter.featuredImage.featuredImageAlt, templateTags) : undefined
    }
    else {
      if (mdxContent.isPost()) {
        if (seoSettings.data.siteWidePostSeoSettings.seoImage.useSiteImage) {
          ...
          seoImageAlt = seoSettings.data.siteWidePostSeoSettings.seoImage.customSeoImageAlt !== "none" ? renderTemplateTags(seoSettings.data.siteWidePostSeoSettings.seoImage.customSeoImageAlt, templateTags) : undefined
        }
      }
        ...
        if (seoSettings.data.siteWidePageSeoSettings.seoImage.useSiteImage) {
          ...
          seoImageAlt = seoSettings.data.siteWidePageSeoSettings.seoImage.customSeoImageAlt !== "none" ? renderTemplateTags(seoSettings.data.siteWidePageSeoSettings.seoImage.customSeoImageAlt, templateTags) : undefined
        }
      }
    }
  }
    ...
    seoImageAlt = mdxContent.data.frontmatter.seoSettings.seoImage.customSeoImageAlt !== "none" ? renderTemplateTags(mdxContent.data.frontmatter.seoSettings.seoImage.customSeoImageAlt, templateTags) : undefined
  }

  const ogTitle = renderTemplateTags(mdxContent.data.frontmatter.seoSettings.openGraph.ogTitle, templateTags)
  const ogDescription = renderTemplateTags(mdxContent.data.frontmatter.seoSettings.openGraph.ogDescription, templateTags)
  ...
  if (mdxContent.data.frontmatter.seoSettings.openGraph.ogImage.ogUseCustomOgImage) {
    ...
    ogImageAlt = mdxContent.data.frontmatter.seoSettings.openGraph.ogImage.ogCustomImageAlt !== "none" ? renderTemplateTags(mdxContent.data.frontmatter.seoSettings.openGraph.ogImage.ogCustomImageAlt, templateTags) : undefined
  }
  let twitterSiteUsername = mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardSiteUsername !== "none" ? renderTemplateTags(mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardSiteUsername, templateTags) : undefined
  ...
  const twitterCardTitle = renderTemplateTags(mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardTitle, templateTags)
  const twitterCardDescription = renderTemplateTags(mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardDescription, templateTags)
  ...
  if (mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardImage.twitterCardUseCustomImage) {
    ...
    twitterCardImageAlt = mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardImage.twitterCardCustomImageAlt !== "none" ? renderTemplateTags(mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardImage.twitterCardCustomImageAlt, templateTags) : undefined
  }
  let twitterUseLargeImage: boolean = mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardType === "summary-card-with-large-image"
  const postTwitterCardType: MdxSeoTwitterCardType = mdxContent.data.frontmatter.seoSettings.twitterCards.twitterCardType;
  if (postTwitterCardType === "site-wide-twitter-card-type") {
    if (mdxContent.isPost()) {
      twitterUseLargeImage = seoSettings.data.siteWidePostSeoSettings.twitterCards.twitterCardType === "summary-card-with-large-image"
    }
    else if (mdxContent.isPage()) {
      twitterUseLargeImage = seoSettings.data.siteWidePageSeoSettings.twitterCards.twitterCardType === "summary-card-with-large-image"
    }
  }
    ...
    <>
      ...
      <Layout>
            ...
            <Col lg={{ span: 8, offset: showSidebar ? 0 : 2 }}>
              <div className="mb-4" style={{ fontSize: "120%" }}>
                <Card className="primary">
                  {!!mdxContent.data.frontmatter.featuredImage.featuredImageEnabled && !!mdxContent.data.frontmatter.featuredImage.featuredImageUrl && mdxContent.data.frontmatter.featuredImage.showCardImage && (
                    <Card.Img variant="top" src={mdxContent.data.frontmatter.featuredImage.featuredImageUrl} alt={mdxContent.data.frontmatter.featuredImage.featuredImageAlt !== "none" ? mdxContent.data.frontmatter.featuredImage.featuredImageAlt : undefined} />
                  )}
                  <Card.Body>
                      ...
                      {!!mdxContent.data.frontmatter.dateEnabled && !!mdxContent.data.frontmatter.date && (
                          ...
                          {mdxContent.data.fields.categorySlug !== "none" && (
                            <>
                              {" in "}
                              <Link
                                to={`/${postCategoryListSlug}/${mdxContent.data.fields.categorySlug}`}
                              >
        ...
        {!!discussionSettings.data.siteWideCommentsEnabled &&
          !!mdxContent.data.frontmatter.discussionEnabled && (
            <Container className="pb-5">
              <Row>
                <Col
                  md={{ span: showSidebar ? 12 : 8, offset: showSidebar ? 0 : 2 }}
                >
                  <Card className="secondary">
                    <Card.Body>
                      <Card.Title>
