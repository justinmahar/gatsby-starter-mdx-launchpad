...
export type ThemeSettingsNavbarColorScheme =
  | "light"
  | "dark"
...
export default class ThemeSettings {
  constructor(public data: ThemeSettingsData) {
    ...
    this.data.bootswatchSettings.bootswatchThemeCDNLocation = this.data.bootswatchSettings.bootswatchThemeCDNLocation.endsWith(
      "/"
    )
      ? this.data.bootswatchSettings.bootswatchThemeCDNLocation
      : this.data.bootswatchSettings.bootswatchThemeCDNLocation + "/"
  }
}