...
Below, all markdown elements are present. This page can be used to preview and customize how markdown is rendered by `MdxNodeRenderer`. See the [README](https://github.com/justinmahar/gatsby-starter-mdx-launchpad#customizing-rendered-markdown) for more information.
...
[a: Link](/markdown-kitchen-sink)

#### img: Image

![alt](/media/site-image.jpg)
...
At a minimum, this means we can use Gatsby's blazing fast Link component in our markdown. 🙌 Beyond that, the sky's the limit.
