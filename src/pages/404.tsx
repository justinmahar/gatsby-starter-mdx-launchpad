...
export default function NotFound(props) {
  ...
  if (seoSettings.data.notFoundPageSeoSettings.seoImage.seoImageSelection === "featured-image-if-enabled") {
    if (builtInPagesSettings.data.notFoundPageSettings.featuredImage.featuredImageEnabled) {
      ...
      seoImageAlt = builtInPagesSettings.data.notFoundPageSettings.featuredImage.featuredImageAlt !== "none" ? renderTemplateTags(builtInPagesSettings.data.notFoundPageSettings.featuredImage.featuredImageAlt, templateTags) : undefined
    }
    else {
    ...
    seoImageAlt = seoSettings.data.notFoundPageSeoSettings.seoImage.customSeoImageAlt !== "none" ? renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.seoImage.customSeoImageAlt, templateTags) : undefined
  }

  const ogTitle = renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.openGraph.ogTitle, templateTags)
  const ogDescription = renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.openGraph.ogDescription, templateTags)
  ...
  if (seoSettings.data.notFoundPageSeoSettings.openGraph.ogImage.ogUseCustomOgImage) {
    ...
    ogImageAlt = seoSettings.data.notFoundPageSeoSettings.openGraph.ogImage.ogCustomImageAlt !== "none" ? renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.openGraph.ogImage.ogCustomImageAlt, templateTags) : undefined
  }
  let twitterSiteUsername = seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardSiteUsername !== "none" ? renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardSiteUsername, templateTags) : undefined
  ...
  const twitterCardTitle = renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardTitle, templateTags)
  const twitterCardDescription = renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardDescription, templateTags)
  ...
  if (seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardImage.twitterCardUseCustomImage) {
    ...
    twitterCardImageAlt = seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardImage.twitterCardCustomImageAlt !== "none" ? renderTemplateTags(seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardImage.twitterCardCustomImageAlt, templateTags) : undefined
  }
  const twitterUseLargeImage: boolean = seoSettings.data.notFoundPageSeoSettings.twitterCards.twitterCardType === "summary-card-with-large-image"
  ...
  return (
    <Layout>
      ...
      <Container className="mt-5 mb-4 text-center">
        ...
        <h5 className="my-4">
          {builtInPagesSettings.data.notFoundPageSettings.bodyText}
        </h5>
        <Row className="my-5">
